(defproject playground "0.1.0-SNAPSHOT"
  ...
  :aliases {"test" ["cljsbuild" "test" "all"]

            "test-task1" ["cljsbuild" "test" "task1"]
            "test-task2" ["cljsbuild" "test" "task2"]
            "test-task3" ["cljsbuild" "test" "task3"]
            "test-task4" ["cljsbuild" "test" "task4"]
            "test-task5" ["cljsbuild" "test" "task5"]}
